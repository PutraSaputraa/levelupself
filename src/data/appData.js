...
export const achievementGroups = [
  ...
  {
    id: 'stamina',
    title: 'Achievement Stamina',
    items: [
      { id: 'stamina-starter', name: 'Stamina Starter', description: 'Menyelesaikan misi stamina pertama', reward: '50 XP' },
      { id: 'endurance-builder', name: 'Endurance Builder', description: 'Menyelesaikan 10 misi stamina', reward: '200 XP' },
      { id: 'early-hydration', name: 'Early Hydration', description: 'Menyelesaikan misi minum air setelah bangun', reward: '75 XP' },
      { id: 'cardio-starter', name: 'Cardio Starter', description: 'Mengumpulkan 15 menit aktivitas stamina', reward: '100 XP' },
      { id: 'recovery-reset', name: 'Recovery Reset', description: 'Menyelesaikan misi pemulihan atau tidur lebih awal', reward: '150 XP' },
      { id: 'stamina-week', name: 'Stamina Week', description: 'Menyelesaikan 15 misi stamina dalam 7 hari', reward: 'Badge' },
    ],
  },
  {
    id: 'tier-xp',
...
export const eventCategories = [
  {
    ...
    missions: [
      { id: 'event-pushup-1', title: 'Push up 1 kali', category: 'strength', metric_type: 'push_up', metric_value: 1, duration_minutes: 2, xp_reward: 10 },
      { id: 'event-pushup-5', title: 'Push up 5 kali', category: 'strength', metric_type: 'push_up', metric_value: 5, duration_minutes: 4, xp_reward: 25 },
      { id: 'event-pushup-10', title: 'Push up 10 kali', category: 'strength', metric_type: 'push_up', metric_value: 10, duration_minutes: 6, xp_reward: 45 },
      { id: 'event-pushup-20', title: 'Push up 20 kali', category: 'strength', metric_type: 'push_up', metric_value: 20, duration_minutes: 10, xp_reward: 75 },
      { id: 'event-pushup-50', title: 'Push up 50 kali', category: 'strength', metric_type: 'push_up', metric_value: 50, duration_minutes: 20, xp_reward: 150 },
      { id: 'event-squat-20', title: 'Bodyweight squat 20 kali', category: 'strength', metric_type: 'strength_mission', metric_value: 1, duration_minutes: 8, xp_reward: 55 },
      { id: 'event-lunge-12', title: 'Lunge 12 kali', category: 'strength', metric_type: 'strength_mission', metric_value: 1, duration_minutes: 7, xp_reward: 45 },
      { id: 'event-hollow-20', title: 'Hollow hold 20 detik', category: 'strength', metric_type: 'strength_mission', metric_value: 1, duration_minutes: 5, xp_reward: 40 },
      { id: 'event-plank-30', title: 'Plank 30 detik', category: 'strength', metric_type: 'strength_mission', metric_value: 1, duration_minutes: 4, xp_reward: 35 },
    ],
  },
  {
    id: 'intelect',
    ...
    missions: [
      { id: 'event-focus-5', title: 'Fokus 5 menit', category: 'intelect', metric_type: 'focus_minutes', metric_value: 5, duration_minutes: 5, xp_reward: 20 },
      { id: 'event-focus-15', title: 'Fokus 15 menit', category: 'intelect', metric_type: 'focus_minutes', metric_value: 15, duration_minutes: 15, xp_reward: 45 },
      { id: 'event-focus-25', title: 'Deep work 25 menit', category: 'intelect', metric_type: 'focus_minutes', metric_value: 25, duration_minutes: 25, xp_reward: 75 },
      { id: 'event-focus-45', title: 'Fokus 45 menit', category: 'intelect', metric_type: 'focus_minutes', metric_value: 45, duration_minutes: 45, xp_reward: 120 },
      { id: 'event-inbox-zero', title: 'Rapikan 10 item inbox', category: 'intelect', metric_type: 'intelect_mission', metric_value: 1, duration_minutes: 12, xp_reward: 45 },
      { id: 'event-read-5', title: 'Baca 5 menit', category: 'intelect', metric_type: 'reading_minutes', metric_value: 5, duration_minutes: 5, xp_reward: 25 },
      { id: 'event-read-10', title: 'Baca 10 menit', category: 'intelect', metric_type: 'reading_minutes', metric_value: 10, duration_minutes: 10, xp_reward: 45 },
      { id: 'event-read-20', title: 'Baca 20 menit', category: 'intelect', metric_type: 'reading_minutes', metric_value: 20, duration_minutes: 20, xp_reward: 80 },
      { id: 'event-note-idea', title: 'Catat 1 ide dari bacaan', category: 'intelect', metric_type: 'reading_mission', metric_value: 1, duration_minutes: 6, xp_reward: 35 },
      { id: 'event-night-read', title: 'Baca sebelum tidur', category: 'intelect', metric_type: 'night_reading', metric_value: 1, duration_minutes: 10, xp_reward: 45 },
    ],
  },
  {
    id: 'mental',
    ...
    missions: [
      { id: 'event-breath-5', title: 'Latihan napas 5 menit', category: 'mental', metric_type: 'mental_mission', metric_value: 1, duration_minutes: 5, xp_reward: 35 },
      { id: 'event-meditate-3', title: 'Meditasi 3 menit', category: 'mental', metric_type: 'meditation_mission', metric_value: 1, duration_minutes: 3, xp_reward: 25 },
      { id: 'event-meditate-7', title: 'Meditasi 7 menit', category: 'mental', metric_type: 'meditation_mission', metric_value: 1, duration_minutes: 7, xp_reward: 45 },
      { id: 'event-reflect-1', title: 'Refleksi 1 paragraf', category: 'mental', metric_type: 'reflection_mission', metric_value: 1, duration_minutes: 8, xp_reward: 40 },
    ],
  },
  {
    id: 'stamina',
    ...
    missions: [
      { id: 'event-walk-fast-10', title: 'Jalan cepat 10 menit', category: 'stamina', metric_type: 'stamina_minutes', metric_value: 10, duration_minutes: 10, xp_reward: 40 },
      { id: 'event-walk-fast-15', title: 'Jalan cepat 15 menit', category: 'stamina', metric_type: 'stamina_minutes', metric_value: 15, duration_minutes: 15, xp_reward: 60 },
      { id: 'event-run-light-8', title: 'Lari ringan 8 menit', category: 'stamina', metric_type: 'run_mission', metric_value: 1, duration_minutes: 8, xp_reward: 55 },
      { id: 'event-stairs-5', title: 'Naik turun tangga 5 menit', category: 'stamina', metric_type: 'stamina_minutes', metric_value: 5, duration_minutes: 5, xp_reward: 40 },
    ],
  },
]
